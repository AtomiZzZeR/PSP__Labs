...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        switch(rand) {
            case 1: 
                FileReader reader1 = new FileReader("sonets/1.txt");
        ...
        while ((line = br.readLine()) != null) {
            System.out.println(line);
                ...
                break;
            case 2: 
                FileReader reader2 = new FileReader("sonets/2.txt");
        ...
        while ((line = br2.readLine()) != null) {
            System.out.println(line);
                ...
                break;
            case 3: 
                FileReader reader3 = new FileReader("sonets/3.txt");
        ...
        while ((line = br3.readLine()) != null) {
            System.out.println(line);
                ...
                break;
            case 4: 
                FileReader reader4 = new FileReader("sonets/4.txt");
        ...
        while ((line = br4.readLine()) != null) {
            System.out.println(line);
                ...
                break;
            case 5: 
                FileReader reader5 = new FileReader("sonets/5.txt");
        ...
        while ((line = br5.readLine()) != null) {
            System.out.println(line);
                ...
                break;
            case 6: 
                FileReader reader6 = new FileReader("sonets/6.txt");
        ...
        while ((line = br6.readLine()) != null) {
            System.out.println(line);
                ...
                break;
            case 7: 
                FileReader reader7 = new FileReader("sonets/7.txt");
        ...
        while ((line = br7.readLine()) != null) {
            System.out.println(line);
                ...
                break;
            case 8: 
                FileReader reader8 = new FileReader("sonets/8.txt");
        ...
        while ((line = br8.readLine()) != null) {
            System.out.println(line);
                ...
                break;
            case 9: 
                FileReader reader9 = new FileReader("sonets/9.txt");
        ...
        while ((line = br9.readLine()) != null) {
            System.out.println(line);
                ...
                break;
            case 10: 
                FileReader reader10 = new FileReader("sonets/10.txt");
